  ...
  @expected_full_ns {
    %{
      "ns.a": %{
        ...
        X:
          {:table,
           %{fields: [x: {:int, %{default: 0}}], indices: %{x: {0, {:int, %{default: 0}}}}}},
        Y:
          {:table,
           %{fields: [y: {:float, %{default: 0}}], indices: %{y: {0, {:float, %{default: 0}}}}}},
        Z:
          {:table,
           %{fields: [z: {:byte, %{default: 0}}], indices: %{z: {0, {:byte, %{default: 0}}}}}}
      },
      "ns.b": %{
        B: {
          :table,
          %{
            fields: [name: {:string, %{}}, a: {:table, %{name: :"ns.a.A"}}],
            indices: %{a: {1, {:table, %{name: :"ns.a.A"}}}, name: {0, {:string, %{}}}}
          }
        }
      }
    },
